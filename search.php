  ...
  <div class="row">
    <div class="col s3 grey lighten-3">
      ...
      <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
        ...
        <div class="section">
        <?php
          $sqlpaperback = "SELECT DISTINCT Paperback from Book where title LIKE '%$schqry%'";
        ...
        <div class="section">
          <h5>Book Type</h5>
          <?php
            $sqlformat = "SELECT DISTINCT b.Format from `book` b JOIN `author` a on b.`AUID` = a.`AUID` where b.title LIKE '%$schqry%'";
        ...
        <div class="section">
          ...
          <label class="radio-inline">
            <?php
              $sqlauthor = "SELECT DISTINCT fName, lName from `author` JOIN `book` on `author`.AUID = `book`.AUID where `book`.Title LIKE '%$schqry%'";
        ...
        <div class="section">
          <h5>Genre</h5>
          <?php
            $sqlgenre = "SELECT DISTINCT b.Genre from `book` b JOIN `author` a on b.`AUID` = a.`AUID` where b.title LIKE '%$schqry%'";
        ...
        <div class="section">
          ...
          <div class="input-field col s12">
            ...
            <?php
              $sqlyear = "SELECT DISTINCT Published FROM `book` where `book`.Title LIKE '%$schqry%' ORDER BY Published DESC";
