...
<div class="container">
  ...
  <div class="section">
    ...
    <div class="section">
      <h5>Loan History</h5>
      <?php
      $sql4 = "SELECT b.BookID, b.Title, b.Image, b.ISBN, a.fName, a.lName, h.ReturnDate FROM Book b, Author a, History h WHERE b.BookID = r.BookID AND b.AUID = a.AUID AND r.MemberID='".$account['MemberID']."' ";
